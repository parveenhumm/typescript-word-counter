...
const answer : {
 ...
 // It defines an array containing a single object representing the question.
// await is used because inquirer.prompt is asynchronous (meaning it finishes later).
(
    [
       {  name : "sentence" ,
